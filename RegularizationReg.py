...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 13 12:27:51 2026
...
ideal_predictions = X @ ideal_coef #@ symbol is the operator for matrix multiplication or dot product
...
#Vizuaizing actual vs predicted
...
#Using lasso to select the most important features and comparing the three diff reg models again on the resulting data

"""
Part 1:Using the coefficient residual plot, select a reasonabe threshold beyond
which the lasso coeff are significant
Create a DF to compare the Lasso Coeff with the ideal Coeff
Include a boolean column that indicates whether the feature was selected as being 
important by the lasso coeff threshold
...
threshold = 5 #Selected by inspection of residual plot
...
#printing the regression performance
regression_results(y_test, y_pred_linear, 'Ordinary')
regression_results(y_test, y_pred_ridge, 'Ridge')
regression_results(y_test, y_pred_lasso, 'Lasso')
